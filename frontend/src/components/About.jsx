          ...
          <div className="flex justify-between items-center mb-[2rem] lg:mb-[3.33vw]">
            ...
            <div>
              <svg viewBox="0 0 640 160" xmlns="http://www.w3.org/2000/svg" className="h-12 md:h-16 w-auto">
                ...
                <text x="165" y="85" fontFamily="Playfair Display, serif" fontSize="32" fill="url(#goldGradientAbout)" letterSpacing="5">
                  SWISS
                </text>

                <text x="165" y="115" fontFamily="Montserrat, sans-serif" fontSize="13" fill="#222222" letterSpacing="7">
                  POOL VILLA
                </text>
          ...
          >
            ...
            >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <AnimatedText 
                    text={services[activeModal].category} 
                    className="text-[1rem] font-medium leading-[1.4] tracking-[.01rem] mb-[.75rem] text-gray-500" 
                    delay={0.1}
                  />
                  <AnimatedText 
                    text={services[activeModal].title} 
                    className="relative text-[1.875rem] font-medium leading-[1.3] mb-[2rem]" 
                    delay={0.2}
                  />
              ...
              {/* Modal Background image stretching right */}
